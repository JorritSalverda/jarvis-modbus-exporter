...
COPY --from=jsalverda/jarvis-modbus-exporter:dlc-builder /app/target target
COPY --from=jsalverda/jarvis-modbus-exporter:dlc-builder /usr/local/cargo /usr/local/cargo
